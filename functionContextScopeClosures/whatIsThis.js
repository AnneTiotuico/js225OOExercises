...
// This will log `NaN` because because `this` refers to the window object and does not have the firstName and lastName properties set to anything so fullName will be equivalent to undefined + undefined which evaluates to NaN.
